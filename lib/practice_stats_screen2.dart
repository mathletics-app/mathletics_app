...
class PracticeStatsScreen2 extends StatefulWidget {
  const PracticeStatsScreen2({super.key});

  @override
  State<PracticeStatsScreen2> createState() => _PracticeStatsScreen2State();
}

class _PracticeStatsScreen2State extends State<PracticeStatsScreen2> {
  final Map<String, String> topicAbbreviations = {
    "FTC Part 1 & 2": "FTC",
    "Techniques of Integration": "TOI",
    "Applications of Integration": "AOI",
    "Binomial Theorem": "BIT",
    "Complex Numbers": "CON",
    "Differential Equations": "DIE",
    "Vectors": "VEC",
    "Matrices": "MAT",
  };
  ...
  void calculateStreaks() {
    final entries = PracticeData2.getAllEntries()
  ...
  void loadStats() {
    ...
    for (int i = 0; i < 7; i++) {
      ...
      int count = PracticeData2.getEntriesForDay(day).length;
...
// Topic Accuracy Graph and Abbreviation legend centered
              LayoutBuilder(
                builder: (context, constraints) {
                  bool isWide = constraints.maxWidth >= 700;
                                  ...
                                  bottomTitles: AxisTitles(
                                    sideTitles: SideTitles(
                                      ...
                                      getTitlesWidget: (value, meta) {
                                        ...
                                        final abbr = topicAbbreviations[topic] ??
                                            (topic.length >= 3 ? topic.substring(0, 3) : topic);
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              'Abbreviations used for topics:\n'
                                  'FTC = Fundamental Theorems of Calculus\n'
                                  'TOI = Techniques of Integration\n'
                                  'AOI = Applications of Integration '
                                  'BIT = Binomial Theorem\n'
                                  'CON = Complex Numbers DIE = Differential Equations\n'
